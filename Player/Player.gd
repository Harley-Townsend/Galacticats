...
func near_ship():
	can_board = true
	$PlayerUserInterface/CanvasLayer/Label.text = "Board [ E ]"
	$PlayerUserInterface/CanvasLayer/Label.visible = true
func not_near_ship():
	can_board = false
	$PlayerUserInterface/CanvasLayer/Label.visible = false
